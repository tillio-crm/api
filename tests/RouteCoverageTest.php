 ...
 * (242 trasy, kontrakt 2.16.0). Sama specyfikacja nie leży w repo - każda instancja serwuje ją
...
final class RouteCoverageTest extends TestCase
{
    ...
    {
        // Twarda liczba ze specyfikacji (kontrakt 2.16.0). Aktualizacja
        // kontraktu = świadoma zmiana tej liczby RAZEM z wpisem i implementacją.
        self::assertCount(242, RouteMap::MAP);
    }
